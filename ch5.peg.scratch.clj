; Representing the keg
(def keg {1  {:pegged true, :connections {6 3, 4 2}},
...
;The meaning of :pegged is clear; it represents whether that position has a peg in it.
...
(row-num 1)
; => 1 ; for pos=1 count=0 row-num=1
(row-num 5)
; => 3
; for pos=5 count=2 row-num=3
