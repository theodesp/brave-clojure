;Multimethods
;Using multimethods, you associate a name with multiple
; implementations by defining a dispatching function,
; which produces dispatching values that are used to
...
; whereas a protocol is a collection of one or more
...
;Protocols do have one limitation: the methods can’t have rest arguments. So a line like the following isn’t allowed:
;
